...
hr_train = read.csv('C:\\Users\\Mr. Jarvis\\Desktop\\DATA SCIENCE PROJECT\\HR PROJECT\\hr_train.csv', stringsAsFactors = F)

hr_test = read.csv("C:\\Users\\Mr. Jarvis\\Desktop\\DATA SCIENCE PROJECT\\HR PROJECT\\hr_test.csv",stringsAsFactors = F)
...
table(unique(hr_all$average_montly_hours))
...
write.csv(test.score,"Nitesh_Bhosle_part2_p4.csv",row.names = F)
